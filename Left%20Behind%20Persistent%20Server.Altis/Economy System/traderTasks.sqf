...
[_container, ["Accept Assassination Task for a Rogue Sniper: $150", "Economy System\functions\taskFunctions\FN_killTaskSniper.sqf", [], 1.5, true, false, "", "true", 3]] remoteExec ['addAction', 0, _container];
